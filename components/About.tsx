...
const About = ({ pageInfo }: Props) => {
  return (
    ...
    >
      <h3 className="absolute top-24 sm:top-20 sm: sm:ml-4 md:top-0 lg:top-[100px] uppercase tracking-[20px] text-[#f7fafab1] text-2xl drop-shadow-md-[10px_30v px_35px_#15c3f3f1] lg:top-10 z-20">
        {" "}
        About{" "}
      </h3>
